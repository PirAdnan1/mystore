  ...
  return (
    <div className="mt-24">
      ...
      <form>
        ...
        <div>
          <p className="mt-9 text-base max-w-[453px]">
        ...
        <button
          type="submit"
          className="py-5 px-20 border mt-[64px] hover:bg-primary hover:border-primary hover:text-white border-black rounded-xl"
        >
          Register
        </button>
      </form>
