  ...
  return (
    <Container>
      <div className="flex flex-col lg:flex-row lg:items-start items-center justify-center xl:gap-20 lg:gap-3 mt-16">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center shrink-0 mt-16">
            <div className="flex items-center">
              ...
              <div className="flex items-center ml-3 mr-5 text-base text-[#9F9F9F]">
                ...
                <span className="md:ml-5 ml-3 whitespace-nowrap">
                  Rs. 50,000.00
                </span>
              </div>
            </div>
        ...
        <div className="bg-[#FFF9E5] flex flex-col justify-center mt-5 md:mt-0 px-20 pb-20 rounded-lg">
          <h1 className="text-center font-semibold text-3xl pt-4">
            Cart Totals
          </h1>

          <div className="flex items-center md:gap-16 gap-8 text-base justify-between pt-14">
            <h3 className="font-semibold">Subtotal</h3>
            <span className="text-[#9F9F9F]">Rs. 50,000.00</span>
          </div>
          <div className="flex items-center md:gap-16 gap-8 text-base mt-8 justify-between">
