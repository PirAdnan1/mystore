...
function Section4() {
  return (
    <Container>
      <h1 className="lg:text-4xl text-2xl text-center font-semibold mt-12">
        Our Blogs
      </h1>
      <p className="text-[#9F9F9F] text-center">
        Find a bright ideal to suit your taste with our great selection
      </p>
      <div className="flex px-8 md:px-12 flex-col space-y-8 md:space-y-0 md:flex-row justify-center md:space-x-8 mt-16">
        <div className="flex flex-col items-center space-y-2">
          ...
          <div>
            <Link
              href="#"
              className="border-b-2 pb-1 font-semibold border-black"
            >
              Read More
            </Link>
          </div>
        ...
        <div className="flex flex-col items-center space-y-2">
          ...
          <div>
            <Link
              href="#"
              className="border-b-2 font-semibold pb-1 border-black"
            >
              Read More
            </Link>
          </div>
